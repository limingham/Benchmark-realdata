...
key_all = key_all[c('MonocyteMacrophage','Endothelial_CXCL12','Cycling_Myeloid','DCs'),]
...
for(ii in names(prd_list_TNBC_realbulk)){
  ...
  prd_in_TNBC = prd_in_TNBC[c('MonocyteMacrophage','Endothelial_CXCL12','Cycling_Myeloid','DCs'),sort(colnames(prd_in_TNBC))]
  prd_in_ER = prd_in_ER[c('MonocyteMacrophage','Endothelial_CXCL12','Cycling_Myeloid','DCs'),sort(colnames(prd_in_ER))]
...
vec_DP_2DP =cor1[upper.tri(cor1)]
