...
source("~/Benchmark-realdata-main/fig1/results_analysis/fig/celltype-wise-PCC/DP_celltypes.R")


source("~/Benchmark-realdata-main/fig1/results_analysis/fig/celltype-wise-PCC/all_celltypes.R")
...
ggsave(
  filename = "~/Benchmark-realdata-main/fig1/results_analysis/fig/pdf/F1D.pdf",  
  plot = p,  
  width = 3,  
  height = 5,  
  units = "in", 
