...
bulk_data <- readRDS("~/Benchmark-realdata-main/fig1/data_preprocess/bulk_data.rds")
sc_TNBC = readRDS.lbzip2('~/Benchmark-realdata-main/fig1/data_preprocess/seurat_use.rdsFS')
sc_TNBC = subset(sc_TNBC,subtype == 'TNBC')
...
for(sample in inter_name){
  ...
  # TNBC_bulk[] <- lapply(TNBC_bulk, function(x) as.integTNBC(as.charactTNBC(x)))
  
  results_path <- paste0("~/Benchmark-realdata-main/fig1/deconvolution_results/TNBC_realbulk/",sample)
