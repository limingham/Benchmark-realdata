...
results_path <- "~/Benchmark-realdata-main/deconvolution_code/tumor/"
...
seurat_ER = readRDS.lbzip2('scRNA/COAD_tumor.rdsFS',n.cores = 100)
...
ER_bulk <- readRDS.lbzip2("bulk_RNA/COAD_tumor.rdsFS",n.cores = 200)
...
source('~/Benchmark-realdata-main/deconvolution_code/run_all_methods.R')
...
func_run_bayes_subject(ref_seurat = seurat_ER,
                       bulk.mtx = ER_bulk,
                       celltype = celltype1,
                       subject = subject1,
