...
bulk_data <- readRDS("~/Benchmark-realdata-main/fig2/data_preprocess/psedobulk.rds")
sc_ER = readRDS.lbzip2('~/Benchmark-realdata-main/fig2/data_preprocess/seurat_use.rdsFS')
sc_ER = subset(sc_ER,subtype == 'TNBC')
...
for(sample in inter_name){
  ...
  results_path <- paste0("~/Benchmark-realdata-main/fig2/deconvolution_results/TNBC_pseudobulk/",sample)
  if (dir.exists(results_path)) {
  } else {
    dir.create(results_path)
  }
  source("/home/lmh/ReCIDE_git/ReCIDE/R/ReCIDE_all_function_beta.R")
  source("/home/lmh/ReCIDE/benchmark_syq/main_run_all_revise.R")
