...
file_list = list.files('~/Benchmark-realdata-main/fig2/deconvolution_results/ER_pseudobulk/')

###########recide
###########
###########
###########
recide_= readRDS(paste0("~/Benchmark-realdata-main/fig2/deconvolution_results/ER_pseudobulk//",file_list[1],"/results_ReCIDE.rds"))

recide_df <- data.frame(recide_[,ll])
rownames(recide_df) <- rownames(recide_)  
for(mm in 2:length(file_list)){
  recide_in_= readRDS(paste0("~/Benchmark-realdata-main/fig2/deconvolution_results/ER_pseudobulk//",file_list[mm],"/results_ReCIDE.rds"))
...
###########
###########
DWLS1= readRDS(paste0("~/Benchmark-realdata-main/fig2/deconvolution_results/ER_pseudobulk//",file_list[1],"/results_DWLS.rds"))
...
for(mm in 2:length(file_list)){
  DWLS_in= readRDS(paste0("~/Benchmark-realdata-main/fig2/deconvolution_results/ER_pseudobulk//",file_list[mm],"/results_DWLS.rds"))
...
###########
###########
music1= readRDS(paste0("~/Benchmark-realdata-main/fig2/deconvolution_results/ER_pseudobulk//",file_list[1],"/results_music.rds"))
...
for(mm in 2:length(file_list)){
  music_in= readRDS(paste0("~/Benchmark-realdata-main/fig2/deconvolution_results/ER_pseudobulk//",file_list[mm],"/results_music.rds"))
...
###########
###########
bisque1= readRDS(paste0("~/Benchmark-realdata-main/fig2/deconvolution_results/ER_pseudobulk//",file_list[1],"/results_bisque.rds"))
...
for(mm in 2:length(file_list)){
  bisque_in= readRDS(paste0("~/Benchmark-realdata-main/fig2/deconvolution_results/ER_pseudobulk//",file_list[mm],"/results_bisque.rds"))
...
###########
###########
bayes1= readRDS(paste0("~/Benchmark-realdata-main/fig2/deconvolution_results/ER_pseudobulk//",file_list[1],"/results_bayes.rds"))
...
for(mm in 2:length(file_list)){
  bayes_in= readRDS(paste0("~/Benchmark-realdata-main/fig2/deconvolution_results/ER_pseudobulk//",file_list[mm],"/results_bayes.rds"))
...
###########
###########
CIBERSORT1= read.table(paste0("~/Benchmark-realdata-main/fig2/deconvolution_results/ER_pseudobulk//",file_list[1],"/results_CIBERSORT.txt"),sep = '\t',row.names = 1,header = TRUE)
...
for(mm in 2:length(file_list)){
  CIBERSORT_in= read.table(paste0("~/Benchmark-realdata-main/fig2/deconvolution_results/ER_pseudobulk//",file_list[mm],"/results_CIBERSORT.txt"),sep = '\t',row.names = 1,header = TRUE)
...
saveRDS(prd_list,file = paste0('~/Benchmark-realdata-main/fig2/results_analysis/ER_pseudobulk/pseudo_ER',ll,'.rds'))
...
saveRDS(rmse_all_list,file = paste0('~/Benchmark-realdata-main/fig2/results_analysis/ER_pseudobulk/pcc_pseudo_ER',ll,'.rds'))
